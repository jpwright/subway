class Station {
    ...
    generate_popup() {
        ...
        station_content += '<div class="station-content"><div class="station-info">'+this.info+'<br /><i class="fa fa-user" aria-hidden="true"></i> <span class="station-ridership">'+Math.round(this.riders).toString()+'</span></div>';
    ...
    update_popup() {
        ...
        $(".station-ridership").text(Math.round(this.riders).toString());
