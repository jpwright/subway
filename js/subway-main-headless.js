...
function initialize_game_state() {
    ...
    N_lines.push(new Line('T', 'T', 'subway-line', '#05AEDE', '#FFFFFF'));
    ...
    N_lines.push(new Line('JFK Express', '&#9992;', 'subway-line', '#05AEDE', '#FFFFFF'));
    ...
    N_line_groups.push(new LineGroup('#05AEDE', [find_line_by_name('T').id, find_line_by_name('JFK Express').id]));
